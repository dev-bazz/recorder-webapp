							...
							<span>
								<svg
									...
									<g clipPath="url(#clip0_205_4761)">
										<path
											fill="#1877F2"
											d="M24.5 12c0-6.628-5.373-12-12-12S.5 5.371.5 12c0 5.989 4.388 10.953 10.125 11.854v-8.386H7.578v-3.469h3.047V9.356c0-3.008 1.791-4.67 4.533-4.67 1.313 0 2.686.235 2.686.235v2.953H16.33c-1.491 0-1.956.925-1.956 1.874V12h3.328l-.532 3.469h-2.796v8.386c5.737-.9 10.125-5.865 10.125-11.855z"></path>
										<path
											fill="#fff"
											d="M17.171 15.469L17.703 12h-3.328V9.749c0-.949.465-1.874 1.956-1.874h1.513V4.922s-1.373-.234-2.686-.234c-2.742 0-4.533 1.66-4.533 4.668V12H7.578v3.469h3.047v8.385a12.084 12.084 0 003.75 0V15.47h2.796z"></path>
									</g>
									<defs>
